...
def init_process_bcast(backend, init_url, init_port, rank, world_size):
    print('tcp://[{}]:{}'.format(init_url, init_port))
    dist.init_process_group(
        backend=backend,
        init_method='tcp://{}:{}'.format(init_url, init_port),
        rank=rank,
...
def main():
    ...
    #init_process(args.backend, args.rank, args.world_size)
    init_process_bcast(args.backend, args.url, args.port, args.rank, args.world_size)
